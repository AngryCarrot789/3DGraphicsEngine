...
//Windows
static const wchar_t GH_TITLE[] = L"3d graphics yee";
static const wchar_t GH_CLASS[] = L"BASE3DGraphics";
...
static const float GH_FOV = 75.0f;
static const float GH_NEAR_MIN = 1e-3f;
static const float GH_NEAR_MAX = 1e-1f;
static const float GH_FAR = 1000.0f;
static const int GH_FBO_SIZE = 2048;
static const int GH_MAX_RECURSION = 4;

//Gameplay
// i play on a really low sensitivity...
// this allows me to make 1 full rotation 
// from my keyboard to edge of mousepad xd
