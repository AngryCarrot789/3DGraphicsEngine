...
Player::Player() {
    Reset();
    hitSpheres.push_back(CollisionSphere(Vector3(0, 0, 0), GH_PLAYER_RADIUS));
    hitSpheres.push_back(CollisionSphere(Vector3(0, GH_PLAYER_RADIUS - GH_PLAYER_HEIGHT, 0), GH_PLAYER_RADIUS));
}
